...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _respositories_article__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../respositories/article */ "./src/respositories/article.js");
...
const index = {
  Query: {
    ...
    article: (parent, {
      ...
      return _respositories_article__WEBPACK_IMPORTED_MODULE_0__["default"].findById(id);
    },
    articles: () => {
      return _respositories_article__WEBPACK_IMPORTED_MODULE_0__["default"].findAll();
    }
  }
};
...
/***/ "./src/respositories/article.js":
/*!**************************************!*\
  !*** ./src/respositories/article.js ***!
  \**************************************/
/*! exports provided: articles, ArticleRepository, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "articles", function() { return articles; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ArticleRepository", function() { return ArticleRepository; });
let articles = [{
  id: 1,
  title: "First Post",
  body: "Lorem Ipzum",
...
/* harmony default export */ __webpack_exports__["default"] = (new ArticleRepository(articles));
...
/***/ (function(module, exports) {
    ...
    var doc = {"kind":"Document","definitions":[{"kind":"ObjectTypeDefinition","name":{"kind":"Name","value":"Article"},"interfaces":[],"directives":[],"fields":[{"kind":"FieldDefinition","name":{"kind":"Name","value":"id"},"arguments":[],"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}},"directives":[]},{"kind":"FieldDefinition","name":{"kind":"Name","value":"title"},"arguments":[],"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},"directives":[]},{"kind":"FieldDefinition","name":{"kind":"Name","value":"body"},"arguments":[],"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},"directives":[]},{"kind":"FieldDefinition","name":{"kind":"Name","value":"posted"},"arguments":[],"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}},"directives":[]}]},{"kind":"ObjectTypeDefinition","name":{"kind":"Name","value":"Query"},"interfaces":[],"directives":[],"fields":[{"kind":"FieldDefinition","name":{"kind":"Name","value":"version"},"arguments":[],"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}},"directives":[]},{"kind":"FieldDefinition","name":{"kind":"Name","value":"articles"},"arguments":[],"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Article"}}}}},"directives":[]},{"kind":"FieldDefinition","name":{"kind":"Name","value":"article"},"arguments":[{"kind":"InputValueDefinition","name":{"kind":"Name","value":"id"},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}},"directives":[]}],"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Article"}}},"directives":[]}]}],"loc":{"start":0,"end":175}};
    doc.loc.source = {"body":"type Article {\n    id: ID!\n    title: String!\n    body: String!\n    posted: Int\n}\n\ntype Query {\n    version: String\n    articles: [Article!]!\n    article(id: ID!): Article!\n}\n","name":"GraphQL request","locationOffset":{"line":1,"column":1}};
